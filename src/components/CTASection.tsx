...
export function CTASection({ onContactClick }: CTASectionProps) {
  ...
  return (
    <section ref={sectionRef} className="py-16 md:py-[var(--section-py-lg)]" style={{ backgroundColor: 'var(--dark-bg)' }}>
      <div className={`max-w-[var(--container-max)] mx-auto px-6 md:px-12 text-center section-content ${isVisible ? 'section-visible' : ''}`}>
        <h2 
