      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6">
          {industries.map((industry, index) => (
            <div
              key={index}
              className="bg-white border border-[var(--border-light)] rounded-lg p-6 md:p-8 hover:shadow-xl transition-all duration-300 hover:border-[var(--industrial-blue)] hover:-translate-y-2 cursor-pointer group"
            >
