                ...
                <div className="section-container">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-[15px] md:text-[17px] text-[var(--text-main)] leading-relaxed mb-2">
                        ...
                        <div className="mb-10">
                            ...
                            <div className="bg-[var(--light-gray)] p-6 rounded-lg mb-4">
                                <p className="text-[14px] md:text-[15px] text-[var(--text-main)] leading-relaxed uppercase font-semibold">
                                ...
                                <p className="text-[14px] md:text-[15px] text-[var(--text-main)] leading-relaxed uppercase font-semibold mt-4">
