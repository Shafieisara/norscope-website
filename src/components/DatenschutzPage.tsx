                ...
                <div className="container-max px-6 md:px-12">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 text-[14px] md:text-[15px] mb-6 text-secondary hover:text-[var(--industrial-blue)] transition-colors"
                        >
                            <span>←</span>
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-[15px] md:text-[17px] text-main leading-relaxed mb-2">
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-[15px] md:text-[17px] text-main leading-relaxed">
                                <strong>Wir setzen folgenden Hoster ein:</strong> Vercel
                            </p>
                        </div>
                        ...
                        <div className="mb-10">
                            ...
                            <div className="text-[15px] md:text-[17px] text-main leading-relaxed space-y-1 mb-4">
                            ...
                            <div className="bg-[var(--light-gray)] p-6 rounded-lg mb-4">
                                <p className="text-[14px] md:text-[15px] text-main leading-relaxed uppercase font-semibold">
                                ...
                                <p className="text-[14px] md:text-[15px] text-main leading-relaxed uppercase font-semibold mt-4">
                            ...
                            <ul className="list-disc pl-6 text-[15px] md:text-[17px] text-main leading-relaxed space-y-2 mb-4">
                        ...
                        {/* Quelle */}
                        <div className="text-[13px] text-secondary pt-6 border-t border-[var(--border-light)]">
                            <p>Quelle: <a href="https://www.e-recht24.de" target="_blank" rel="noopener noreferrer" className="text-[var(--industrial-blue)] hover:underline">https://www.e-recht24.de</a></p>
