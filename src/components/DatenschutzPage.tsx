                ...
                <div className="max-w-[1440px] mx-auto px-6 md:px-12">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-[15px] md:text-[17px] text-[#4A4A4A] leading-relaxed mb-2">
                        ...
                        <div className="mb-10">
                            ...
                            <div className="bg-[var(--light-gray)] p-6 rounded-lg mb-4">
                                <p className="text-[14px] md:text-[15px] text-[#4A4A4A] leading-relaxed uppercase font-semibold">
                                ...
                                <p className="text-[14px] md:text-[15px] text-[#4A4A4A] leading-relaxed uppercase font-semibold mt-4">
                            ...
                            <ul className="list-disc pl-6 text-[15px] md:text-[17px] text-[#4A4A4A] leading-relaxed space-y-2 mb-4">
                        ...
                        {/* Quelle */}
                        <div className="text-[13px] text-[#6B6B6B] pt-6 border-t border-[var(--border-light)]">
